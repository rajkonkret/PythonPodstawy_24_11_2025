...
resp = r'''{"description": "Zmienna to miejsce w pami\u0119ci komputera, gdzie przechowywana jest warto\u015b\u0107. W Pythonie zmienna przypisywana jest do nazwy za pomoc\u0105 operatora `=`.",
 "example": "nazwa = \"Python\"\nwiek = 30\nczy_aktywny = True",
 "id": 1,
 "level": "podstawowy",
"term": "Co to jest zmienna w Pythonie?"}'''
